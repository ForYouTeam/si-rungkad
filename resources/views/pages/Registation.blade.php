...
<div class="col-lg-12">
  <div class="card">
    <div class="card-haeder">
      <h4 class="mt-5" style="float: left">Data Registrasi Pasien</h4>
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <div class="col-md-12">
              ...
              <input type="text" class="form-control" name="no_registrasi" id="no_registrasi" placeholder="No Registrasi" required>
            ...
            <div class="col-md-12">
              ...
              <input type="date" class="form-control" name="tgl_registrasi" id="tgl_registrasi" placeholder="Tanggal Registrasi" required>
            ...
            <div class="col-md-12">
              ...
              <input type="text" class="form-control" name="qr_code" id="qr_code" placeholder="QR code" required>
